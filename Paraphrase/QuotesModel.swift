...
//  Paraphrase
//
//  Created by Sean Quinn on 6/8/19.
...
struct QuotesModel {
  ...
  init(testing: Bool = false) {
    ...
    if testing {
      // adding a seed of 1 makes it so that the Mersenne Twister algorithm
      // starts in a specific state sothat we generate random numbers in the
